...
public static class ConfiguracaoCatalog
{
    ...
    [
        ...
        new(CategoriaConfiguracao.GoogleAds, "DiagnosticsEnabled", TipoConfiguracao.Booleano, false, "false", "GOOGLE_ADS_DIAGNOSTICS_ENABLED", "GoogleAds:DiagnosticsEnabled", "Habilita endpoints internos de diagnostico Google Ads."),
